INSERT INTO users (id, `created_at`, `email`, `first_name`, `last_name`, `password`, `updated_at`, is_active, provider) VALUES (1, '2019-10-24 17:55:56', 'nursultan@peaksoft.us', 'Nursultan', 'Turdaliev', '$2a$10$ZuhGJnhIGZJ6dmVwPAJJiu1qQOARFImW8cdGzK9UngDedhG8d1zSm', '2019-10-24 17:55:56', true, 'local');
insert into users (id, first_name, last_name, email, password, provider) values (2, 'Nurali', 'Akimov', 'nurali.akimov@gmail.com','{bcrypt}$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'local');
